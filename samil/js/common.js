...
$(document).ready(function(){
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li').on('mouseenter focusin', function(){
        if(device_status == 'pc'){
            $('header').addClass('over') /* 1차 메뉴 오버시 header 2차메뉴 뒷 배경이 나타남*/
        }
    })
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li').on('mouseenter focusin', function(){
        if(device_status == 'pc'){
            $(this).addClass('over')  /* 1차 메뉴 오버시 글자가 바뀌고 밑줄 생김*/
        }
    })
    $('header .gnb .gnb_wrap ul.depth1 > li').on('mouseleave', function(){
    ...
    /***************** 모바일 2차 메뉴 열고 닫기 ************/
    $('header .gnb .gnb_wrap ul.depth1 > li:has(.depth2) > a').on('click', function(e){
